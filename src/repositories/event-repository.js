...
export const getAllAsync = async (pageNumber=1, limit, filters) => {
    const sql = `SELECT
                 events.id,
                 events.name,
                 events.description,
...
export const getEnrollmentCountAsync = async (id) => {
...
export const doEnrollmentCheckAsync = async (id, userId) => {
    const sql = `SELECT
                 e.id AS event_id,
                 e.max_assistance,
                 e.start_date,
...
export const doUnenrollmentCheckAsync = async (id, userId) => {
    const sql = `SELECT
                 e.id AS event_id,
                 e.start_date,
                 (
...
export const checkEnrollmentAsync = async (id, userId) => {
...
export const enrollAsync = async (id, userId) => {
...
export const unenrollAsync = async (id, userId) => {
